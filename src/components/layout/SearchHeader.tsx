        ...
        <div ref={containerRef} className="space-y-4 px-4 pt-4 pb-2 sticky top-0 bg-background/80 backdrop-blur-md z-50 border-b border-black/5">
            ...
            <div className="flex items-center justify-between gap-4">
                ...
                <button
                    ...
                    className={cn(
                        "relative p-2 mb-2 rounded-full border transition-all",
                        showNotifications
                            ? "bg-black border-black text-white"
                            : "border-black/5 text-zinc-400 hover:text-black hover:bg-zinc-100"
                    )}
                >
            ...
            {showNotifications && (
                <div className="absolute top-[calc(100%+8px)] right-4 w-72 bg-white border border-black/5 rounded-2xl shadow-2xl p-6 animate-in fade-in slide-in-from-top-2 duration-300 z-[60]">
